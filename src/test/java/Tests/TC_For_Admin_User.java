...
public class TC_For_Admin_User 
{
	WebDriver driver;
	...
	public void create_Structure_Type_Project_without_having_google_or_amazon_attachment_and_By_click_On_Create_Button() throws Exception
	{
		...
		{
		Project_Page.create_project_Button(driver);
		Project_Page.project_basic_details(driver);
		Project_Page.select_Project_Type(driver,"Structure");
		Project_Page.select_Processing_Engine(driver);
		Project_Page.statuses(driver,"Structure");
		Project_Page.template_Details(driver);
		Project_Page.roles_Details(driver);
		Project_Page.user_Details_For_Roles_Section(driver);
		Project_Page.document_investigation_details(driver);
		Project_Page.gcp_document_investigation_details(driver);
		Project_Page.api_configuration_Details(driver);
		Project_Page.create_Button(driver); 
		Thread.sleep(2000);
		driver.quit();
		}
	...
	public void create_Semi_Structure_Type_Project_without_having_google_or_amazon_attachment_and_By_click_On_Create_Button() throws Exception
	{
		...
		Project_Page.create_project_Button(driver);
		Project_Page.project_basic_details(driver);
		Project_Page.select_Project_Type(driver,"Semi-Structure");
		Project_Page.select_Processing_Engine(driver);
		Project_Page.statuses(driver,"Semi-Structure");
     	Project_Page.roles_Details(driver);
     	Project_Page.user_Details_For_Roles_Section(driver);
		Project_Page.document_investigation_details(driver);
		Project_Page.gcp_document_investigation_details(driver);
	...
	public void create_Free_Form_Type_Project_without_having_google_or_amazon_attachment_and_By_click_On_Create_Button() throws Exception
	{
		...
		Project_Page.create_project_Button(driver);
		Project_Page.project_basic_details(driver);
		Project_Page.select_Project_Type(driver,"Free-Form");
		Project_Page.statuses(driver,"Free-Form");
		Project_Page.add_attribute_details_For_Free_Form_Project_Type(driver, "PatientName");
		Project_Page.roles_Details(driver);
		Project_Page.user_Details_For_Roles_Section(driver);
		Project_Page.document_investigation_details(driver);
		Project_Page.gcp_document_investigation_details(driver);
