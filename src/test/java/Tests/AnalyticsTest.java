...
public class AnalyticsTest extends BasePage {
	...
	public void test_organization_arrows_on_analytics_page() throws Exception {
	  ...
	  @Test(priority = 2) public void hover_total_users_on_Analytics_page() throws Exception 
	  { 
	  ...
	  @Test(priority = 5) public void hover_ready_to_process_on_Analytics_page()  throws Exception 
	  { 
	  ...
	  @Test(priority = 6) public void  hover_ready_to_rejected_documents_on_Analytics_page() throws Exception 
	  { 
	  ...
	  @Test(priority = 13) public void select_overall_data_on_Analytics_page()
	  ...
	  @Test(priority = 15) public void select_weekly_data_on_Analytics_page()
	  throws Exception 
	  { 
		  //1.15 Weekly Data. 
